...
return [
    ...
    */
    ...
    'connections' => [
        ...
        'mysql' => [
            ...
            'pool' => [
                'min_connections' => env('DB_POOL_MIN', 50),
                'max_connections' => env('DB_POOL_MAX', 500),
    ...
    */
    ...
    'redis' => [
        ...
        'cluster' => [
            'seeds' => [
                env('REDIS_CLUSTER_NODE1', '127.0.0.1:7000'),
                env('REDIS_CLUSTER_NODE2', '127.0.0.1:7001'),
                env('REDIS_CLUSTER_NODE3', '127.0.0.1:7002'),
            ],
            'timeout' => env('REDIS_TIMEOUT', 5),
            'read_timeout' => env('REDIS_READ_TIMEOUT', 5),
            'persistent' => true,
