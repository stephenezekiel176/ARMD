...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
        <div class="flex items-center">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Add Facilitator</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1">Create a new facilitator account</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
        <form method="POST" action="{{ route('admin.facilitators.store') }}" class="space-y-6 p-6">
            @csrf
