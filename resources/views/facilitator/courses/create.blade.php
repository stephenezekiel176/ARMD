...
<div class="space-y-6">
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-6">
        <div class="flex items-center">
            ...
            <div>
                <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Create New Course</h1>
                <p class="text-gray-600 dark:text-gray-400 mt-1">Upload your video, ebook, audio, image, or podcast content</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 shadow rounded-lg">
        <form method="POST" action="{{ route('facilitator.courses.store') }}" 
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <div class="mt-2 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                            ...
                            <label class="relative flex cursor-pointer rounded-lg border p-4 shadow-sm focus:outline-none
                                {{ old('type') === 'video' ? 'border-primary-500 bg-primary-50 dark:bg-primary-900/20' : 'border-gray-300 dark:border-gray-600' }}">
                            ...
                            <!-- E-Book Course -->
                            <label class="relative flex cursor-pointer rounded-lg border p-4 shadow-sm focus:outline-none
                                {{ old('type') === 'ebook' ? 'border-primary-500 bg-primary-50 dark:bg-primary-900/20' : 'border-gray-300 dark:border-gray-600' }}">
                                <input type="radio" name="type" value="ebook" class="sr-only" 
                                       {{ old('type') === 'ebook' ? 'checked' : '' }} required>
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <span class="block text-sm font-medium text-gray-900 dark:text-gray-100">📚 E-Book Course</span>
                            ...
                            <!-- Audio Course -->
                            <label class="relative flex cursor-pointer rounded-lg border p-4 shadow-sm focus:outline-none
                                {{ old('type') === 'audio' ? 'border-primary-500 bg-primary-50 dark:bg-primary-900/20' : 'border-gray-300 dark:border-gray-600' }}">
                                <input type="radio" name="type" value="audio" class="sr-only" 
                                       {{ old('type') === 'audio' ? 'checked' : '' }} required>
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <span class="block text-sm font-medium text-gray-900 dark:text-gray-100">🎵 Audio Course</span>
                                        <span class="block text-sm text-gray-500 dark:text-gray-400">MP3, WAV, M4A files</span>
                                    </div>
                                </div>
                            </label>
                            ...
                            <!-- Image Course -->
                            <label class="relative flex cursor-pointer rounded-lg border p-4 shadow-sm focus:outline-none
                                {{ old('type') === 'image' ? 'border-primary-500 bg-primary-50 dark:bg-primary-900/20' : 'border-gray-300 dark:border-gray-600' }}">
                                <input type="radio" name="type" value="image" class="sr-only" 
                                       {{ old('type') === 'image' ? 'checked' : '' }} required>
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <span class="block text-sm font-medium text-gray-900 dark:text-gray-100">🖼️ Image Course</span>
                                        <span class="block text-sm text-gray-500 dark:text-gray-400">JPG, PNG, GIF files</span>
                                    </div>
                                </div>
                            </label>
                            ...
                            <!-- Podcast Course -->
                            <label class="relative flex cursor-pointer rounded-lg border p-4 shadow-sm focus:outline-none
                                {{ old('type') === 'podcast' ? 'border-primary-500 bg-primary-50 dark:bg-primary-900/20' : 'border-gray-300 dark:border-gray-600' }}">
                                <input type="radio" name="type" value="podcast" class="sr-only" 
                                       {{ old('type') === 'podcast' ? 'checked' : '' }} required>
                                <div class="flex items-center">
                                    ...
                                    <div>
                                        <span class="block text-sm font-medium text-gray-900 dark:text-gray-100">🎙️ Podcast Course</span>
                                        <span class="block text-sm text-gray-500 dark:text-gray-400">MP3, WAV, M4A files</span>
                                    </div>
                                </div>
                            </label>
                    ...
                    <div>
                        ...
                        <textarea id="description" 
                                  ...
                                  class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-700 dark:text-white shadow-sm focus:border-primary-500 focus:ring-primary-500">{{ old('description') }}</textarea>
                        @error('description')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                        ...
                        <div class="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-gray-600 border-dashed rounded-md hover:border-primary-400 transition-colors">
                            <div class="space-y-1 text-center">
                                ...
                                <p class="text-xs text-gray-500 dark:text-gray-400">
                                    Video files (MP4, AVI, MOV), Ebook files (PDF, EPUB, MOBI), Audio files (MP3, WAV, M4A), Image files (JPG, PNG, GIF), or Podcast files (MP3, WAV, M4A) up to 100MB
                                </p>
                            </div>
                        </div>
                        @error('file')
